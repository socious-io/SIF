...
export const Projects = () => {
  ...
  const isIdentityUser = true;

  return (
    <>
      <div className="flex flex-col items-center md:p-8 md:pb-[6rem] relative bg-Gray-light-mode-50">
        <div className="w-full flex flex-col items-center gap-6 px-4 py-16 md:p-[6rem] bg-Brand-800 shadow-lg md:rounded-3xl text-xl font-normal leading-8 text-Brand-200 text-center">
          ...
          <div className="flex items-center gap-3 mt-6 mb-8">
            <Button
              color="inherit"
              customStyle="!h-auto min-w-[9.25rem] !p-4 text-Gray-light-mode-700"
            ...
            <Button
              color="primary"
              customStyle="!h-auto min-w-[9.25rem] !p-4"
        ...
        <div className="max-w-full md:max-w-[60rem] flex flex-col mx-4 bg-Base-White shadow-md rounded-xl overflow-hidden absolute top-[calc(100%-2rem)] md:top-[calc(100%-9.75rem)]">
          ...
          <div className="flex flex-col gap-4 p-8">
            ...
            <div className="flex flex-col items-stretch md:flex-row md:items-center gap-4 py-4">
              <div className="flex-1 flex flex-col gap-1 text-sm text-Gray-light-mode-600">
                <span className="text-5xl font-semibold text-Brand-700">16</span>
                projects
              </div>
              <div className="flex-1 flex flex-col gap-1 text-sm text-Gray-light-mode-600">
                <span className="text-5xl font-semibold text-Brand-700">160</span>
                days to go
              </div>
              <div className="flex-1 flex flex-col gap-1 text-sm text-Gray-light-mode-600">
                <span className="text-5xl font-semibold text-Brand-700">$50,000</span>
                matching pool
              </div>
            </div>
          </div>
      ...
      <div
        className={`flex flex-col items-stretch gap-16 ${isIdentityUser ? 'mt-[55rem] md:mt-[32rem]' : 'mt-[52.5rem] md:mt-[29.5rem]'} px-4 py-[7rem] md:p-[6rem] md:pb-[10rem]`}
      >
        <div className="md:max-w-[60rem] md:px-[90px] self-center flex flex-col gap-2 leading-6 text-Gray-light-mode-600">
        ...
        <div className="flex flex-col items-center gap-6 md:mx-8 p-8 bg-Gray-light-mode-50 border-4 rounded-2xl">
          <img src={AvatarGroup} alt="support" width={120} height={56} />
          <div className="flex flex-col items-center gap-2 text-Gray-light-mode-600">
